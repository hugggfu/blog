  ...
  <div class="wrapper">
    <div style="margin: 100px auto; background-color: #fff; width: 350px; height: 400px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-input placeholder="请输入邮箱" size="medium" style="margin: 5px 0" prefix-icon="el-icon-user" v-model="user.email"></el-input>
      </el-form-item>
        ...
        <el-form-item style="margin: 5px 0; text-align: right">
          ...
          <el-button type="primary" size="small"  autocomplete="off" @click="$router.push('/home')">返回主页</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
    ...
    login() {
      this.$refs['userForm'].validate((valid) => {
        if (valid) {  // 表单校验合法
          ...
          this.request.post("/front/user/register", this.user).then(res => {
            if(res.code === 200) {
